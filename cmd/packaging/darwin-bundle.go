...
func InitDarwinBundle() {
	...
	fileutils.ExecuteTemplateFromAssetsBox("packaging/darwin-bundle/Info.plist.tmpl.tmpl", filepath.Join(bundleContentsDirectoryPath, "Info.plist.tmpl"), fileutils.AssetsBox, getTemplateData(projectName, ""))
