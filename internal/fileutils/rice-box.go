...
func init() {
	...
	file2 := &embedded.EmbeddedFile{
		Filename:    "README.md",
		FileModTime: time.Unix(1587381276, 0),
	...
	file4 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1567669633, 0),
	...
	file8 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1554198752, 0),
	...
	filea := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1553026267, 0),

		Content: string("package main\n\nimport (\n\t\"github.com/go-flutter-desktop/go-flutter\"\n)\n\nvar options = []flutter.Option{\n\tflutter.WindowInitialDimensions(800, 1280),\n}\n"),
	}
	filed := &embedded.EmbeddedFile{
		Filename:    "packaging/darwin-bundle/Info.plist.tmpl.tmpl",
		FileModTime: time.Unix(1575972965, 0),
	...
	filef := &embedded.EmbeddedFile{
		Filename:    "packaging/darwin-pkg/Distribution.tmpl.tmpl",
		FileModTime: time.Unix(1587047493, 0),
	...
	fileg := &embedded.EmbeddedFile{
		Filename:    "packaging/darwin-pkg/PackageInfo.tmpl.tmpl",
		FileModTime: time.Unix(1575972965, 0),

		Content: string("<pkg-info format-version=\"2\" identifier=\"{{.organizationName}}.base.pkg\" version=\"{{`{{.version}}`}}\" install-location=\"/\" auth=\"root\">\n\t<bundle-version>\n\t\t<bundle id=\"{{.organizationName}}\" CFBundleIdentifier=\"{{.organizationName}}\" path=\"./Applications/{{.projectName}}.app\" CFBundleVersion=\"{{`{{.version}}`}}\"/>\n    </bundle-version>\n</pkg-info>"),
	}
	...
	filen := &embedded.EmbeddedFile{
		Filename:    "packaging/linux-deb/control.tmpl.tmpl",
		FileModTime: time.Unix(1577548293, 0),

		Content: string("Package: {{.strippedProjectName}}\nArchitecture: amd64\nMaintainer: @{{.author}}\nPriority: optional\nVersion: {{`{{.version}}`}}\nDescription: {{.description}}\n"),
	}
	filep := &embedded.EmbeddedFile{
		Filename:    "packaging/linux-pkg/PKGBUILD.tmpl.tmpl",
		FileModTime: time.Unix(1587047493, 0),

		Content: string("pkgname={{.projectName}}\npkgver={{`{{.version}}`}}\npkgrel={{`{{.release}}`}}\npkgdesc=\"{{.description}}\"\narch=(\"x86_64\")\nlicense=('FIXME')\n\npackage() {\n    mkdir -p $pkgdir/\n    cp * $pkgdir/ -r\n}\n"),
	}
	filer := &embedded.EmbeddedFile{
		Filename:    "packaging/linux-rpm/app.spec.tmpl.tmpl",
		FileModTime: time.Unix(1587047493, 0),

		Content: string("Name: {{.projectName}}\nVersion: {{`{{.version}}`}}\nRelease: {{`{{.release}}`}}\nSummary: {{.description}}\nLicense: FIXME\n\n%description\n{{.description}}\n\n%install\nmkdir -p $RPM_BUILD_ROOT%{_bindir}\nmkdir -p $RPM_BUILD_ROOT/usr/lib/{{.projectName}}\nmkdir -p $RPM_BUILD_ROOT%{_datadir}/applications\ncp -r $RPM_BUILD_DIR $RPM_BUILD_ROOT\nchmod 0755 $RPM_BUILD_ROOT%{_bindir}/{{.projectName}}\nchmod 0755 $RPM_BUILD_ROOT%{_datadir}/applications/{{.projectName}}.desktop\n\n%files\n%{_bindir}/{{.projectName}}\n/usr/lib/{{.projectName}}/\n%{_datadir}/applications/{{.projectName}}.desktop"),
	}
	filet := &embedded.EmbeddedFile{
		Filename:    "packaging/linux-snap/snapcraft.yaml.tmpl.tmpl",
		FileModTime: time.Unix(1577548293, 0),

		Content: string("name: {{.strippedProjectName}}\nbase: core18\nversion: '{{`{{.version}}`}}'\nsummary: {{.description}}\ndescription: |\n  {{.description}}\nconfinement: devmode\ngrade: devel\napps:\n  {{.strippedProjectName}}:\n    command: {{.projectName}}\n    desktop: local/{{.projectName}}.desktop\nparts:\n  desktop:\n    plugin: dump\n    source: snap\n  assets:\n    plugin: dump\n    source: build/assets\n  app:\n    plugin: dump\n    source: build\n    stage-packages:\n      - libx11-6\n      - libxrandr2\n      - libxcursor1\n      - libxinerama1\n"),
	}
	filev := &embedded.EmbeddedFile{
		Filename:    "packaging/windows-msi/app.wxs.tmpl.tmpl",
		FileModTime: time.Unix(1575972965, 0),
	...
	filey := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1570118744, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1587380355, 0),
	...
	dir3 := &embedded.EmbeddedDir{
		Filename:   "app",
		DirModTime: time.Unix(1587047493, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			file4, // "app/gitignore"
			file5, // "app/go.mod"
			file6, // "app/hover.yaml"
			file7, // "app/icon.png"
			file8, // "app/main.go"
	...
	dirc := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1575972965, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filed, // "packaging/darwin-bundle/Info.plist.tmpl.tmpl"
	...
	dire := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1587047493, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filef, // "packaging/darwin-pkg/Distribution.tmpl.tmpl"
			fileg, // "packaging/darwin-pkg/PackageInfo.tmpl.tmpl"
	...
	dirh := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1575972965, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filei, // "packaging/linux/app.desktop.tmpl"
			filej, // "packaging/linux/bin.tmpl"
	...
	dirk := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1575972965, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filel, // "packaging/linux-appimage/AppRun.tmpl"

		},
	}
	dirm := &embedded.EmbeddedDir{
		Filename:   "packaging/linux-deb",
		DirModTime: time.Unix(1577548293, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filen, // "packaging/linux-deb/control.tmpl.tmpl"
	...
	diro := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1587047493, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filep, // "packaging/linux-pkg/PKGBUILD.tmpl.tmpl"
	...
	dirq := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1587047493, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filer, // "packaging/linux-rpm/app.spec.tmpl.tmpl"
	...
	dirs := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1577548293, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filet, // "packaging/linux-snap/snapcraft.yaml.tmpl.tmpl"
	...
	diru := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1575972965, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filev, // "packaging/windows-msi/app.wxs.tmpl.tmpl"
	...
	dirw := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1575972965, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filex,  // "plugin/README.md.dlib.tmpl"
			filey,  // "plugin/README.md.tmpl"
			filez,  // "plugin/import.go.tmpl.tmpl"
			file10, // "plugin/plugin.go.tmpl"
	...
	dirb.ChildDirs = []*embedded.EmbeddedDir{
		dirc, // "packaging/darwin-bundle"
		dire, // "packaging/darwin-pkg"
		dirh, // "packaging/linux"
		dirk, // "packaging/linux-appimage"
		dirm, // "packaging/linux-deb"
		diro, // "packaging/linux-pkg"
		dirq, // "packaging/linux-rpm"
		dirs, // "packaging/linux-snap"
		diru, // "packaging/windows-msi"
	...
	embedded.RegisterEmbeddedBox(`../../assets`, &embedded.EmbeddedBox{
		Name: `../../assets`,
		Time: time.Unix(1587380355, 0),
		Dirs: map[string]*embedded.EmbeddedDir{
			"":                         dir1,
			"app":                      dir3,
			"packaging":                dirb,
			"packaging/darwin-bundle":  dirc,
			"packaging/darwin-pkg":     dire,
			"packaging/linux":          dirh,
			"packaging/linux-appimage": dirk,
			"packaging/linux-deb":      dirm,
			"packaging/linux-pkg":      diro,
			"packaging/linux-rpm":      dirq,
			"packaging/linux-snap":     dirs,
			"packaging/windows-msi":    diru,
			"plugin":                   dirw,
		},
		Files: map[string]*embedded.EmbeddedFile{
			...
			"app/gitignore":                                 file4,
			"app/go.mod":                                    file5,
			"app/hover.yaml":                                file6,
			"app/icon.png":                                  file7,
			"app/main.go":                                   file8,
			"app/main_desktop.dart":                         file9,
			"app/options.go":                                filea,
			"packaging/darwin-bundle/Info.plist.tmpl.tmpl":  filed,
			"packaging/darwin-pkg/Distribution.tmpl.tmpl":   filef,
			"packaging/darwin-pkg/PackageInfo.tmpl.tmpl":    fileg,
			"packaging/linux/app.desktop.tmpl":              filei,
			"packaging/linux/bin.tmpl":                      filej,
			"packaging/linux-appimage/AppRun.tmpl":          filel,
			"packaging/linux-deb/control.tmpl.tmpl":         filen,
			"packaging/linux-pkg/PKGBUILD.tmpl.tmpl":        filep,
			"packaging/linux-rpm/app.spec.tmpl.tmpl":        filer,
			"packaging/linux-snap/snapcraft.yaml.tmpl.tmpl": filet,
			"packaging/windows-msi/app.wxs.tmpl.tmpl":       filev,
			"plugin/README.md.dlib.tmpl":                    filex,
			"plugin/README.md.tmpl":                         filey,
			"plugin/import.go.tmpl.tmpl":                    filez,
			"plugin/plugin.go.tmpl":                         file10,
		},
	})
}
